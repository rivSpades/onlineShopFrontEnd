            ...
            <div className="col-lg-4 col-md-6">
              <div className="product-card hover-btn">
                ...
                <div className="product-card-content">
                  <h6>
                    <Link legacyBehavior href="/shop/product-detail">
                      <a className="hover-underline">Velvet Red Charm</a>
                    </Link>
                  </h6>
                  <p>
                    <Link legacyBehavior href="/shop">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="product-card hover-btn">
                <div className="product-card-img">
                  ...
                  <div className="overlay">
                    <div className="cart-area">
                      <Link legacyBehavior href="/product-with-size-variation">
                        <a className="hover-btn3 add-cart-btn ">
                          Select options
                        </a>
                      </Link>
                ...
                <div className="product-card-content">
                  <h6>
                    <Link legacyBehavior href="/shop/product-detail">
                      <a className="hover-underline">Hydrating Waves</a>
                    </Link>
                  </h6>
                  <p>
                    <Link legacyBehavior href="/shop">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="product-card hover-btn">
                ...
                <div className="product-card-content">
                  <h6>
                    <Link legacyBehavior href="/shop/product-detail">
                      <a className="hover-underline">Organic Jojoba Blend</a>
                    </Link>
                  </h6>
                  <p>
                    <Link legacyBehavior href="/shop">
                  ...
                  <div className="col-lg-6">
                    <div className="shop-details-content">
                      ...
                      <div className="shop-details-btn">
                        ...
                        <a href="#" className="primary-btn1 style-3 hover-btn4">
                          *Add to Cart*
                        </a>
                      </div>
                      <div className="product-info">
                        <ul className="product-info-list">
                          ...
                          <li>
                            {' '}
                            <span>Brand:</span>{' '}
                            <Link legacyBehavior href="/shop-4-columns">
                              <a>Chanel</a>
                            </Link>
                          </li>
                          <li>
