          ...
          <div className="row gy-4">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="product-card hover-btn">
                ...
                <div className="product-card-content">
                  <h6><Link legacyBehavior href="/shop/product-default"><a  className="hover-underline">Hydrating Waves</a></Link></h6>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="product-card hover-btn">
                ...
                <div className="product-card-content">
                  <h6><Link legacyBehavior href="/shop/product-default"><a  className="hover-underline">Organic Jojoba Blend</a></Link></h6>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="product-card hover-btn">
                ...
                <div className="product-card-content">
                  <h6><Link legacyBehavior href="/shop/product-default"><a  className="hover-underline">Nourishing Herbal Cleanse</a></Link></h6>
