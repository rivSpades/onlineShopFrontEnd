                    ...
                    <div className="product-card style-4">
                      <div className="product-card-img double-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/home1/sp-product-img-01.png"
                              alt=""
                              className="img1"
                            />
                            <img
                              src="/assets/img/home1/sp-product-img-05.png"
                              alt=""
                              className="img2"
                            />
                            <div className="batch">
                  ...
                  <div className="slide-item">
                    <div className="product-card style-4">
                      ...
                      <div className="product-card-content">
                        <h6>
                          <Link legacyBehavior href="/shop/product-detail">
                            <a className="hover-underline">Dewy Fresh Face</a>
                          </Link>
                        </h6>
                        <p>
                          <Link legacyBehavior href="/shop">
                    ...
                    <div className="product-card style-4">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/home1/sp-product-img-03.png"
                              alt=""
                            />
                            <div className="batch">
                              <span>-15%</span>
                      ...
                      <div className="product-card-content">
                        <h6>
                          <Link legacyBehavior href="/shop/product-detail">
                            <a className="hover-underline">Rose Petal Flush</a>
                          </Link>
                        </h6>
                        <p>
                          <Link legacyBehavior href="/shop">
                    ...
                    <div className="product-card style-4">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/home1/sp-product-img-04.png"
                              alt=""
                            />
                            <div className="batch">
                              <span>-15%</span>
                    ...
                    <div className="product-card style-4">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/home1/sp-product-img-06.png"
                              alt=""
                            />
                            <div className="batch">
                              <span>-15%</span>
                      ...
                      <div className="product-card-content">
                        <h6>
                          <Link legacyBehavior href="/shop/product-detail">
                            <a className="hover-underline">Intensive Cream</a>
                          </Link>
                        </h6>
                        <p>
                          <Link legacyBehavior href="/shop">
