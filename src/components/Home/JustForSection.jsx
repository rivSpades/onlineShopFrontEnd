...
const JustForSection = () => {
  return (
    <div className="just-for-section mb-110">
      <img
        src="/assets/img/home1/icon/vector-1.svg"
        alt=""
        className="vector1"
      />
      <img
          ...
          <div className="col-lg-3">
            ...
            >
              <button
                ...
                id="v-Korean-tab"
                data-bs-toggle="pill"
                data-bs-target="#v-Korean"
                type="button"
                role="tab"
                aria-controls="v-Korean"
                aria-selected="true"
              >
                Korean Product
                <span>(30)</span>
              ...
              <button
                ...
                id="v-makeup-tab"
                data-bs-toggle="pill"
                data-bs-target="#v-makeup"
                type="button"
                role="tab"
                aria-controls="v-makeup"
                aria-selected="false"
              >
                Makeup
                <span>(40)</span>
              ...
              <button
                ...
                id="v-skin-care-tab"
                data-bs-toggle="pill"
                data-bs-target="#v-skin-care"
                type="button"
                role="tab"
                aria-controls="v-skin-care"
                aria-selected="false"
              >
                Skin Care
                <span>(32)</span>
              ...
              <button
                className="nav-link"
                id="v-personal-care-tab"
                data-bs-toggle="pill"
                data-bs-target="#v-personal-care"
                type="button"
                role="tab"
                aria-controls="v-personal-care"
                aria-selected="false"
              >
                Personal Care
                <span>(28)</span>
              ...
              <button
                ...
                id="v-fragrance-tab"
                data-bs-toggle="pill"
                data-bs-target="#v-fragrance"
                type="button"
                role="tab"
                aria-controls="v-fragrance"
                aria-selected="false"
              >
                Fragrance
                <span>(19)</span>
              ...
              <button
                ...
                id="v-health-tab"
                data-bs-toggle="pill"
                data-bs-target="#v-health"
                type="button"
                role="tab"
                aria-controls="v-health"
                aria-selected="false"
              >
                Health &amp; Care
                <span>(21)</span>
              ...
              <button
                className="nav-link"
                id="v-accessories-tab"
                data-bs-toggle="pill"
                data-bs-target="#v-accessories"
                type="button"
                role="tab"
                aria-controls="v-accessories"
                aria-selected="false"
              >
                Accessories
                <span>(36)</span>
              ...
              <button
                ...
                id="v-kids-tab"
                data-bs-toggle="pill"
                data-bs-target="#v-kids"
                type="button"
                role="tab"
                aria-controls="v-kids"
                aria-selected="false"
              >
                Kids &amp; Baby
                <span>(55)</span>
              ...
              <button
                ...
                id="v-skin-care2-tab"
                data-bs-toggle="pill"
                data-bs-target="#v-skin-care2"
                type="button"
                role="tab"
                aria-controls="v-skin-care2"
                aria-selected="false"
              >
                Skin Care
                <span>(68)</span>
            ...
            <div className="offer-img hover-img">
              ...
              <div className="discount-buy">
                ...
                <Link legacyBehavior href="/shop">
                  <a className="buy-btn hover-btn4">*Buy Now*</a>
                </Link>
              </div>
            </div>
          </div>
          <div className="col-lg-9">
            <div className="tab-content" id="v-pills-tabContent">
                      ...
                      <div className="product-card-img double-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            ...
                            />
                            <img
                              src="/assets/img/home1/product-img-22.png"
                              alt=""
                              className="img2"
                            />
                            <div className="batch">
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="product-card style-2 hover-btn">
                      ...
                      <div className="product-card-content">
                        <h6>
                          <Link legacyBehavior href="/shop/product-detail">
                            <a className="hover-underline">Vivid Eye Pencil</a>
                          </Link>
                        </h6>
                        <p>
                          <Link legacyBehavior href="/shop">
                    ...
                    <div className="product-card style-2 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/home1/product-img-10.png"
                              alt=""
                            />
                            <div className="batch">
                              <span>-15%</span>
              ...
              <div
                ...
                id="v-skin-care"
                role="tabpanel"
                aria-labelledby="v-skin-care-tab"
              >
                <div className="row gy-4">
                  <div className="col-xl-4 col-md-6">
                    <div className="product-card style-2 hover-btn">
              ...
              <div
                ...
                id="v-personal-care"
                role="tabpanel"
                aria-labelledby="v-personal-care-tab"
              >
                <div className="row gy-4">
                  <div className="col-xl-4 col-md-6">
                    <div className="product-card style-2 hover-btn">
              ...
              <div
                ...
                id="v-fragrance"
                role="tabpanel"
                aria-labelledby="v-fragrance-tab"
              >
                <div className="row gy-4">
                  <div className="col-xl-4 col-md-6">
                    <div className="product-card style-2 hover-btn">
              ...
              <div
                ...
                id="v-accessories"
                role="tabpanel"
                aria-labelledby="v-accessories-tab"
              >
                <div className="row gy-4">
                  <div className="col-xl-4 col-md-6">
                    <div className="product-card style-2 hover-btn">
              ...
              <div
                ...
                id="v-skin-care2"
                role="tabpanel"
                aria-labelledby="v-skin-care2-tab"
              >
                <div className="row gy-4">
                  <div className="col-xl-4 col-md-6">
                    <div className="product-card style-2 hover-btn">
