                  ...
                  <div className="row g-4">
                    <div className="col-lg-6">
                      <div className="exclusive-product-left">
                        ...
                        <p>
                          Whatever your summer looks like, bring your own heat
                          with up to 25% off Lumin Brand.Pellentesque ipsum dui,
                          laoreet vitae ex in, pellentesque aliquam leo.
                        </p>
                        <ul>
                          <li>
                            <svg
                      ...
                      <div className="exclusive-product-right">
                        <div className="product-right-img hover-img">
                          <Link legacyBehavior href="/shop/product-detail">
                            <a>
                              <img
                                src="/assets/img/home1/ex-product-img-01.png"
                                alt=""
                              />
                            </a>
                          </Link>
                      ...
                      <div className="exclusive-product-right">
                        <div className="product-right-img hover-img">
                          <Link legacyBehavior href="/shop/product-detail">
                            <a>
                              <img
                                src="/assets/img/home1/ex-product-img-02.png"
                                alt=""
                              />
                            </a>
                          </Link>
                      ...
                      <div className="exclusive-product-right">
                        <div className="product-right-img hover-img">
                          <Link legacyBehavior href="/shop/product-detail">
                            <a>
                              <img
                                src="/assets/img/home1/ex-product-img-03.png"
                                alt=""
                              />
                            </a>
                          </Link>
