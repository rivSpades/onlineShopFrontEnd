          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="product-card2">
              ...
              <div className="product-card-content">
                ...
                <h6>
                  <Link legacyBehavior href="/shop/product-detail">
                    <a className="hover-underline">Prism Eyeshadow Palette</a>
                  </Link>
                </h6>
                <span>
                  $170.00 <del>$200.00</del>
                </span>
            ...
            <div className="product-card2">
              ...
              <div className="product-card-img double-img">
                <Link legacyBehavior href="/shop">
                  <a>
                    <img
                      src="/assets/img/home2/product-img-3.png"
                      alt=""
                      className="img1"
                    />
                    <img
              ...
              <div className="product-card-content">
                ...
                <h6>
                  <Link legacyBehavior href="/shop/product-detail">
                    <a className="hover-underline">Hydrating Red Lip Stain.</a>
                  </Link>
                </h6>
                <span>
                  $187.00 <del>$200.00</del>
                </span>
                <div className="rating">
                  <ul>
                    <li>
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="product-card2">
              ...
              <div className="product-card-content">
                ...
                <h6>
                  <Link legacyBehavior href="/shop/product-detail">
                    <a className="hover-underline">Brightening Serum cream</a>
                  </Link>
                </h6>
                <span>
                  $176.00 <del>$200.00</del>
                </span>
                <div className="rating">
                  <ul>
                    <li>
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="product-card2">
              ...
              <div className="product-card-content">
                ...
                <h6>
                  <Link legacyBehavior href="/shop/product-detail">
                    <a className="hover-underline">Hydrating Lip Gloss pack</a>
                  </Link>
                </h6>
                <span>
            ...
            <div className="product-card2">
              ...
              <div className="product-card-img double-img">
                <Link legacyBehavior href="/shop">
                  <a>
                    <img
                      src="/assets/img/home2/product-img-6.png"
                      alt=""
                      className="img1"
                    />
                    <img
              ...
              <div className="product-card-content">
                ...
                <h6>
                  <Link legacyBehavior href="/shop/product-detail">
                    <a className="hover-underline">Salt Spray Beachy Waves</a>
                  </Link>
                </h6>
                <span>
                  $155.00 <del>$200.00</del>
                </span>
                <div className="rating">
                  <ul>
                    <li>
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="product-card2">
              ...
              <div className="product-card-content">
                ...
                <h6>
                  <Link legacyBehavior href="/shop/product-detail">
                    <a className="hover-underline">Necessaire the deodorant</a>
                  </Link>
                </h6>
                <span>
                  $143.00 <del>$200.00</del>
                </span>
                <div className="rating">
                  <ul>
                    <li>
          ...
          <div className="col-xl-3 col-lg-4 col-sm-6">
            <div className="product-card2">
              ...
              <div className="product-card-content">
                ...
                <h6>
                  <Link legacyBehavior href="/shop/product-detail">
                    <a className="hover-underline">Makeup Smooth brushes</a>
                  </Link>
                </h6>
                <span>
                  $132.00 <del>$200.00</del>
                </span>
                <div className="rating">
                  <ul>
                    <li>
