      ...
      <div className="container">
          ...
          <ul className="nav nav-pills" id="pills-tab" role="tablist">
            <li className="nav-item" role="presentation">
              <button
                ...
                id="sg-skin-tab"
                data-bs-toggle="pill"
                data-bs-target="#sg-skin"
                type="button"
                role="tab"
                aria-controls="sg-skin"
                aria-selected="true"
              >
                Skin Care
              </button>
            ...
            <li className="nav-item" role="presentation">
              <button
                ...
                id="sg-fragrance-tab"
                data-bs-toggle="pill"
                data-bs-target="#sg-fragrance"
                type="button"
                role="tab"
                aria-controls="sg-fragrance"
                aria-selected="false"
              >
                Fragrance
              </button>
            ...
            <li className="nav-item" role="presentation">
              <button
                className="nav-link"
                id="sg-accessories-tab"
                data-bs-toggle="pill"
                data-bs-target="#sg-accessories"
                type="button"
                role="tab"
                aria-controls="sg-accessories"
                aria-selected="false"
              >
                Accessories
              </button>
            ...
            <li className="nav-item" role="presentation">
              <button
                ...
                id="sg-makeup-tab"
                data-bs-toggle="pill"
                data-bs-target="#sg-makeup"
                type="button"
                role="tab"
                aria-controls="sg-makeup"
                aria-selected="false"
              >
                Makeup
              </button>
            ...
            <li className="nav-item" role="presentation">
              <button
                ...
                id="sg-care-tab"
                data-bs-toggle="pill"
                data-bs-target="#sg-care"
                type="button"
                role="tab"
                aria-controls="sg-care"
                aria-selected="false"
              >
                Personal Care
              </button>
        ...
        <div className="tab-content mb-60" id="pills-tabContent">
                    ...
                    <div className="product-card2">
                      ...
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop">
                          <a>
                            <img
                              src="/assets/img/home2/product-img-9.png"
                              alt=""
                            />
                          </a>
                        </Link>
                        <div className="cart-btn-area">
                          <div className="cart-btn">
                            <Link legacyBehavior href="/shop/cart">
                              <a className="add-cart-btn2 round hover-btn5">
                    ...
                    <div className="product-card2">
                      ...
                      <div className="product-card-img double-img">
                        <Link legacyBehavior href="/shop">
                          <a>
                            <img
                              src="/assets/img/home2/product-img-10.png"
                              alt=""
                              className="img1"
                            />
                            <img
                              src="/assets/img/home2/product-img-13.png"
                              alt=""
                              className="img2"
                            />
                          </a>
                      ...
                      <div className="product-card-content">
                        ...
                        <h6>
                          <Link legacyBehavior href="/shop/product-detail">
                            <a className="hover-underline">
                              Magical Eyelash Extensions
                            </a>
                          </Link>
                        </h6>
                        <span>
                          $172.00 <del>$200.00</del>
                        </span>
                        <div className="rating">
                          <ul>
                            <li>
                        ...
                        <div className="product-card2 style-2">
                          ...
                          <div className="product-card-img">
                            <Link legacyBehavior href="/shop">
                              <a>
                                <img
                                  src="/assets/img/home2/suggest-slider-img-1.png"
                                  alt=""
                                />
                              </a>
                            </Link>
                        ...
                        <div className="product-card2 style-2">
                          ...
                          <div className="product-card-img">
                            <Link legacyBehavior href="/shop">
                              <a>
                                <img
                                  src="/assets/img/home2/suggest-slider-img-2.png"
                                  alt=""
                                />
                              </a>
                            </Link>
                          ...
                          <div className="product-card-content">
                            ...
                            <h6>
                              <Link legacyBehavior href="/shop/product-detail">
                                <a className="hover-underline">
                                  Timeless Amber Essence
                                </a>
                              </Link>
                            </h6>
                            <span>
                              $220.00 <del>$250.00</del>
                            </span>
                            <div className="rating">
                              <ul>
                                <li>
                        ...
                        <div className="product-card2 style-2">
                          ...
                          <div className="product-card-img">
                            <Link legacyBehavior href="/shop">
                              <a>
                                <img
                                  src="/assets/img/home2/suggest-slider-img-3.png"
                                  alt=""
                                />
                              </a>
                            </Link>
                        ...
                        <div className="product-card2 style-2">
                          ...
                          <div className="product-card-img">
                            <Link legacyBehavior href="/shop">
                              <a>
                                <img
                                  src="/assets/img/home2/suggest-slider-img-4.png"
                                  alt=""
                                />
                              </a>
                            </Link>
                    ...
                    <div className="product-card2">
                      ...
                      <div className="product-card-img double-img">
                        <Link legacyBehavior href="/shop">
                          <a>
                            <img
                              src="/assets/img/home2/product-img-11.png"
                              alt=""
                              className="img1"
                            />
                            <img
                              src="/assets/img/home2/product-img-8.png"
                              alt=""
                              className="img2"
                            />
                          </a>
                      ...
                      <div className="product-card-content">
                        ...
                        <h6>
                          <Link legacyBehavior href="/shop/product-detail">
                            <a className="hover-underline">
                              Lip Stain &amp; Makeup box
                            </a>
                          </Link>
                        </h6>
                        <span>
                          $190.00 <del>$200.00</del>
                        </span>
                        <div className="rating">
                          <ul>
                            <li>
                    ...
                    <div className="product-card2">
                      ...
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop">
                          <a>
                            <img
                              src="/assets/img/home2/product-img-12.png"
                              alt=""
                            />
                          </a>
                        </Link>
                      ...
                      <div className="product-card-content">
                        ...
                        <h6>
                          <Link legacyBehavior href="/shop/product-detail">
                            <a className="hover-underline">
                              Floral new Perfume Mist
                            </a>
                          </Link>
                        </h6>
                        <span>
                          $165.00 <del>$200.00</del>
                        </span>
                        <div className="rating">
                          <ul>
                            <li>
          ...
          <div
            ...
            id="sg-fragrance"
            role="tabpanel"
            aria-labelledby="sg-fragrance-tab"
          >
            <div className="row g-4">
              <div className="col-lg-3">
                <div className="row g-4">
          ...
          <div
            ...
            id="sg-accessories"
            role="tabpanel"
            aria-labelledby="sg-accessories-tab"
          >
            <div className="row g-4">
              <div className="col-lg-3">
                <div className="row g-4">
        ...
        <div className="view-product-btn text-center">
          <Link legacyBehavior href="/shop">
            <a className="primary-btn3 hover-btn5">view All Product</a>
          </Link>
        </div>
      </div>
    </div>
