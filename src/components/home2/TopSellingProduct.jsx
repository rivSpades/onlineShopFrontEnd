                    ...
                    <div className="product-card-content">
                      ...
                      <h6>
                        <Link legacyBehavior href="/shop/product-detail">
                          <a className="hover-underline">Brightening Vitamin</a>
                        </Link>
                      </h6>
                      <span>
                  ...
                  <div className="product-card2">
                    ...
                    <div className="product-card-img">
                      <Link legacyBehavior href="/shop">
                        <a>
                          <img
                            src="/assets/img/home2/product-img-14.png"
                            alt=""
                          />
                        </a>
                      </Link>
                  ...
                  <div className="product-card2">
                    ...
                    <div className="product-card-img">
                      <Link legacyBehavior href="/shop">
                        <a>
                          <img
                            src="/assets/img/home2/product-img-15.png"
                            alt=""
                          />
                        </a>
                      </Link>
                  ...
                  <div className="product-card2">
                    ...
                    <div className="product-card-img">
                      <Link legacyBehavior href="/shop">
                        <a>
                          <img
                            src="/assets/img/home2/product-img-16.png"
                            alt=""
                          />
                        </a>
                      </Link>
                  ...
                  <div className="product-card2">
                    ...
                    <div className="product-card-img">
                      <Link legacyBehavior href="/shop">
                        <a>
                          <img
                            src="/assets/img/home2/product-img-1.png"
                            alt=""
                          />
                        </a>
                      </Link>
                  ...
                  <div className="product-card2">
                    ...
                    <div className="product-card-img">
                      <Link legacyBehavior href="/shop">
                        <a>
                          <img
                            src="/assets/img/home2/product-img-2.png"
                            alt=""
                          />
                        </a>
                      </Link>
