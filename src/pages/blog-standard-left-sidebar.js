...
const BlogStandardLeftSidebarPage = () => {
  return (
    <>
      <div className="blog-standard-left-sidebar-section mt-110 mb-110">
...
export default BlogStandardLeftSidebarPage;
