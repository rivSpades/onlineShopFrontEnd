...
const ProductWithSizeVariation = () => {
              ...
              <div className="shop-details-content">
                ...
                <div className="quantity-color-area">
                  <div className="quantity-color">
                    ...
                    <QuantityCounter/>
                    {/* <div className="quantity-counter two">
                  ...
                  <div className="quantity-color">
                    ...
                    {[250,500,1000,1500].map((_, index) => (
                          <li
                            key={index}
                            className={`select-wrap ${size === index ? 'selected' : ''}`}
...
export default ProductWithSizeVariation
