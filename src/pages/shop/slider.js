                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img double-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/inner-page/face-product1.png"
                              alt=""
                              className="img1"
                            />
                            <img
                        ...
                        <div className="overlay">
                          <div className="cart-area">
                            <a href="#" className="hover-btn3 add-cart-btn">
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/inner-page/face-product2.png"
                              alt=""
                            />
                            <div className="batch">
                              <span>-18%</span>
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/inner-page/face-product3.png"
                              alt=""
                            />
                            <div className="batch">
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img double-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/inner-page/face-product4.png"
                              alt=""
                              className="img1"
                            />
                            <img
                              src="/assets/img/home1/sp-product-img-02.png"
                              alt=""
                              className="img2"
                            />
                            <div className="batch">
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/inner-page/product-img-5.png"
                              alt=""
                            />
                            <div className="batch">
                              <span className="new">New</span>
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a className="hover-underline">
                            <img
                              src="/assets/img/inner-page/product-img-6.png"
                              alt=""
                            />
                            <div className="batch">
                              <span>-13%</span>
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/inner-page/body-product1.png"
                              alt=""
                            />
                            <div className="batch">
                              <span>-15%</span>
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/inner-page/body-product2.png"
                              alt=""
                            />
                            <div className="countdown-timer">
                              <ul data-countdown={endTime}>
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/inner-page/body-product4.png"
                              alt=""
                            />
                            <div className="batch">
                              <span>-20%</span>
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/inner-page/hair-product1.png"
                              alt=""
                            />
                            <div className="batch">
                              <span>-15%</span>
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/inner-page/hair-product2.png"
                              alt=""
                            />
                            <div className="batch">
                              <span>-13%</span>
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/inner-page/hair-product3.png"
                              alt=""
                            />
                            <div className="batch">
                              <span>-15%</span>
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/inner-page/hair-product4.png"
                              alt=""
                            />
                            <div className="batch">
                              <span className="new">New</span>
          ...
          <div className="row">
            <div className="col-12">
              <Swiper
                {...makeupNav}
                {...slideSettings}
                className="swiper makeup-slider"
              >
                <div className="swiper-wrapper">
                  <SwiperSlide className="swiper-slide">
                    <div className="product-card style-3 hover-btn">
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/home1/product-img-8.png"
                              alt=""
                            />
                            <div className="batch">
                              <span>-15%</span>
