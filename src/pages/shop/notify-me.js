            ...
            <div className="col-lg-6">
              <div className="shop-details-content style-3">
                ...
                <div className="shop-details-btn">
                  <a className="primary-btn1 style-3">*Out Of Stock*</a>
                  <a className="primary-btn1 hover-btn3" data-bs-toggle="modal" data-bs-target="#notify">*Notify Me When Available*</a>
                </div>
                ...
                <div className="modal fade" id="notify" data-bs-keyboard="false" tabIndex={-1} aria-hidden="true">
                  <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                      <div className="modal-header">
                        <h4 className="modal-title" id="alartModal01Label">Alert Me When Available</h4>
                      ...
                      <div className="modal-body">
                        <div className="notify-me-form">
                          <form>
                            ...
                            <a href="#" className="primary-btn1 hover-btn3">Submit Now</a>
                          </form>
                        </div>
                      </div>
                    </div>
