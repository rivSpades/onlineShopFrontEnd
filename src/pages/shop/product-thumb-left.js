...
const ProductThumbLeft = () => {
  ...
  return (
    <>
      <div className="shop-details-top-section style-2 mt-110 mb-110"> 
        <div className="container-xl container-fluid-lg container">
          <div className="row g-lg-4 gy-5">
            <div className="col-lg-5">
              <div className="shop-details-img">
                <div className="nav nav-pills order-xl-1 order-2" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <div className="tab-content order-xl-2 order-1" id="v-pills-tabContent">
                  <div className="tab-pane fade show active" id="v-pills-img1" role="tabpanel">
                    <div className="shop-details-tab-img">
                      <img src="/assets/img/inner-page/shop-details2-tab-img1.png" alt="" />
                      <span />
                    </div>
                  </div>
                  <div className="tab-pane fade" id="v-pills-img2" role="tabpanel">
                    <div className="shop-details-tab-img">
                      <img src="/assets/img/inner-page/shop-details2-tab-img2.png" alt="" />
                      <span />
                    </div>
                  </div>
                  <div className="tab-pane fade" id="v-pills-img3" role="tabpanel" aria-labelledby="v-pills-img3-tab">
                    <div className="shop-details-tab-img">
                      <img src="/assets/img/inner-page/shop-details2-tab-img3.png" alt="" />
                      <span />
                    </div>
                  </div>
                  <div className="tab-pane fade" id="v-pills-img4" role="tabpanel" aria-labelledby="v-pills-img4-tab">
                    <div className="shop-details-tab-img">
                      <img src="/assets/img/inner-page/shop-details2-tab-img4.png" alt="" />
                      <span />
                    </div>
                  </div>
                </div>
        ...
        <div className="container-xl container-lg-fluid container">
          <div className="row">
            <div className="col-12">
              <div className="shop-details-description-nav mb-60">
                <nav>
                  <div className="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <button className="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Reviews (15)</button>
                  </div>
                </nav>
              </div>
              <div className="shop-details2-description-tab">
                <div className="tab-content" id="nav-tabContent">
                  <div className="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div className="row gy-5">
                      <div className="col-lg-9">
                        <div className="details2-description-content">
                          <h1>They’re kinda our Best thing!</h1>
                          <p>Donec accumsan justo eget porta pellentesque. Etiam vitae malesuada lorem, sed lobortis arcu. Aenean onegn vulputate ligula eu elit porttitor tempus. Suspendisse ultrices augue ac tempus hendrerit. Integer id cursusourc ligula, quis faucibus enim. Donec sit amet aliquam leo. Donec eget risus elementum, finibus elit vel, goutava condimentum sapien. In hac habitasse platea dictumst. Cras faucibus lacus scelerisque elementum aliquam. Ut porta efficitur metus sed varius.Cras faucibus lacus scelerisque elementum aliquam. Ut porta efficitur metus sed varius. Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, deleniti.</p>
                          <p>vulputate ligula eu elit porttitor tempus. Suspendisse ultrices augue ac tempus hendrerit. Integer id cursusourc ligula, quis faucibus enim. Donec sit amet aliquam leo.</p>
                          <ul>
                            <li>
                      ...
                      <div className="col-lg-3 d-flex justify-content-lg-end justify-content-center">
                        <div className="details2-description-img">
                          <img src="/assets/img/inner-page/details2-description-img.png" alt="" />
                        </div>
                      </div>
                    </div>
                  </div>
