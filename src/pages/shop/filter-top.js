...
const FilterTop = () => {
  ...
  return (
    <>
      <div className="filter-top-section mt-110 mb-110">
        <div className="container-xl container-fluid">
          ...
          <div className={`filter-top ${isdropdown ? 'slide' : ''}`}>
            <div className="sidebar-area style-2">
              <div className="row">
                <div className="col-xl-2 col-lg-3 filter-divider">
                  <div className="shop-widget two">
                ...
                <div className="col-xl-3 col-lg-2 filter-divider">
                  <div className="shop-widget two">
                    <div className="check-box-item">
                ...
                <div className="col-xl-4 col-lg-4 filter-divider">
                  <div className="shop-widget two">
                    ...
                    <div className="top-product-widget mb-20">
                      <div className="top-product-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/inner-page/top-product2.png"
                              alt=""
                            />
                          </a>
                        </Link>
                    ...
                    <div className="top-product-widget">
                      <div className="top-product-img">
                        <Link legacyBehavior href="/shop/product-detail">
                          <a>
                            <img
                              src="/assets/img/inner-page/top-product3.png"
                              alt=""
                            />
                          </a>
                        </Link>
                ...
                <div className="col-xl-3 col-lg-3">
                  <div className="shop-widget two">
                    ...
                    <div className="filter-btn text-center pt-100">
