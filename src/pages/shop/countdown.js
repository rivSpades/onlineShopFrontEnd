                ...
                <div className="shop-details-content style-3">
                  ...
                  <div className="countdown-timer">
                    <ul data-countdown={endTime}>
                      <li className="times" data-days={days}>{days}<span>Day</span></li>
                  
                      <li className="times" data-hours={hours}>{hours}<span>Hour</span></li>
                
                      <li className="times" data-minutes={minutes}>{minutes}<span>Minute</span></li>
              
                      <li className="times" data-seconds={seconds}>{seconds}<span>secound</span></li>
                    </ul>
                  </div>
