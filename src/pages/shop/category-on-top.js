  ...
  return (
    <>
      <div className="category-on-top-section">
        <img
          src="/assets/img/inner-page/category-top-vector1.png"
          alt=""
          className="ct-vector1"
        />
        <img
          src="/assets/img/inner-page/category-top-vector2.png"
          alt=""
          className="ct-vector2"
        />
              ...
              <div className="swiper-wrapper">
                <SwiperSlide className="swiper-slide">
                  <div className="nav-item" role="presentation">
                    <a
                      href="#category-top-img1"
                      className="nav-link active"
                      id="category-top-img1-tab"
                      data-bs-toggle="pill"
                      data-bs-target="#category-top-img1"
                      role="tab"
                      aria-controls="category-top-img1"
                      aria-selected="true"
                    >
                      <img
                        src="/assets/img/inner-page/category-top-nav-img1.png"
                        alt=""
                      />
                    </a>
                    <h6>Bath &amp; Body</h6>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="nav-item" role="presentation">
                    <a
                      href="#"
                      className="nav-link"
                      id="category-top-img2-tab"
                      data-bs-toggle="pill"
                      data-bs-target="#category-top-img2"
                      role="tab"
                      aria-controls="category-top-img2"
                      aria-selected="true"
                    >
                      <img
                        src="/assets/img/inner-page/category-top-nav-img2.png"
                        alt=""
                      />
                    </a>
                    <h6>Makeup</h6>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="nav-item" role="presentation">
                    <a
                      href="#"
                      className="nav-link"
                      id="category-top-img3-tab"
                      data-bs-toggle="pill"
                      data-bs-target="#category-top-img3"
                      role="tab"
                      aria-controls="category-top-img3"
                      aria-selected="true"
                    >
                      <img
                        src="/assets/img/inner-page/category-top-nav-img3.png"
                        alt=""
                      />
                    </a>
                    <h6>Skin Care</h6>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="nav-item" role="presentation">
                    <a
                      href="#"
                      className="nav-link"
                      id="category-top-img4-tab"
                      data-bs-toggle="pill"
                      data-bs-target="#category-top-img4"
                      role="tab"
                      aria-controls="category-top-img4"
                      aria-selected="true"
                    >
                      <img
                        src="/assets/img/inner-page/category-top-nav-img4.png"
                        alt=""
                      />
                    </a>
                    <h6>Fragrance </h6>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="nav-item" role="presentation">
                    <a
                      href="#"
                      className="nav-link"
                      id="category-top-img5-tab"
                      data-bs-toggle="pill"
                      data-bs-target="#category-top-img5"
                      role="tab"
                      aria-controls="category-top-img5"
                      aria-selected="true"
                    >
                      <img
                        src="/assets/img/inner-page/category-top-nav-img5.png"
                        alt=""
                      />
                    </a>
                    <h6>Hair Care</h6>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="nav-item" role="presentation">
                    <a
                      href="#"
                      className="nav-link"
                      id="category-top-img6-tab"
                      data-bs-toggle="pill"
                      data-bs-target="#category-top-img6"
                      role="tab"
                      aria-controls="category-top-img6"
                      aria-selected="true"
                    >
                      <img
                        src="/assets/img/inner-page/category-top-nav-img6.png"
                        alt=""
                      />
                    </a>
                    <h6>Accessories</h6>
                  ...
                  <div className="col-lg-6">
                    <div className="shop-details-img">
                      <div className="tab-content" id="view-tabContent">
                        ...
                        >
                          <div className="shop-details-tab-img">
                            <img
                              src="/assets/img/inner-page/shop-details-tab-img1.png"
                              alt=""
                            />
                          </div>
                        </div>
                        ...
                        >
                          <div className="shop-details-tab-img">
                            <img
                              src="/assets/img/inner-page/shop-details-tab-img2.png"
                              alt=""
                            />
                          </div>
                        </div>
                        ...
                        >
                          <div className="shop-details-tab-img">
                            <img
                              src="/assets/img/inner-page/shop-details-tab-img3.png"
                              alt=""
                            />
                          </div>
                        </div>
                        ...
                        >
                          <div className="shop-details-tab-img">
                            <img
                              src="/assets/img/inner-page/shop-details-tab-img4.png"
                              alt=""
                            />
                          </div>
                        </div>
                      ...
                      >
                        ...
                        >
                          <img
                            src="/assets/img/inner-page/shop-details-nav-img1.png"
                            alt=""
                          />
                        </button>
                        <button
                          className="nav-link"
                          id="view-pills-img2-tab"
                          data-bs-toggle="pill"
                          data-bs-target="#view-pills-img2"
                          type="button"
                          role="tab"
                          aria-controls="view-pills-img2"
                          aria-selected="false"
                        >
                          <img
                            src="/assets/img/inner-page/shop-details-nav-img2.png"
                            alt=""
                          />
                        </button>
                        <button
                          className="nav-link"
                          id="view-pills-img3-tab"
                          data-bs-toggle="pill"
                          data-bs-target="#view-pills-img3"
                          type="button"
                          role="tab"
                          aria-controls="view-pills-img3"
                          aria-selected="false"
                        >
                          <img
                            src="/assets/img/inner-page/shop-details-nav-img3.png"
                            alt=""
                          />
                        </button>
                        <button
                          className="nav-link"
                          id="view-pills-img4-tab"
                          data-bs-toggle="pill"
                          data-bs-target="#view-pills-img4"
                          type="button"
                          role="tab"
                          aria-controls="view-pills-img4"
                          aria-selected="false"
                        >
                          <img
                            src="/assets/img/inner-page/shop-details-nav-img4.png"
                            alt=""
                          />
                        </button>
                      </div>
                  ...
                  <div className="col-lg-6">
                    <div className="shop-details-content">
                      ...
                      <p>
                        ...
                        nostra, per inceptos only placerat felis non
                        aliquam.Mauris nec justo vitae ante auctor tol euismod
                        sit amet Praesent commodo at massa eget suscipit. Utani
                        vitae enim velit.
                      </p>
                      ...
                      <div className="shop-details-btn">
                        ...
                        <Link legacyBehavior href="/shop/cart">
                          <a className="primary-btn1 style-3 hover-btn4">
                            *Add to Cart*
                          </a>
                        </Link>
                      </div>
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop">
                          <a>
                            <img
                              src="/assets/img/home1/product-img-5.png"
                              alt=""
                            />
                            <div className="batch">
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop">
                          <a>
                            <img
                              src="/assets/img/home1/product-img-6.png"
                              alt=""
                            />
                            <div className="batch">
                              <span>-14%</span>
                    ...
                    <div className="product-card style-3 hover-btn">
                      <div className="product-card-img">
                        <Link legacyBehavior href="/shop">
                          <a>
                            <img
                              src="/assets/img/home1/product-img-9.png"
                              alt=""
                            />
                            <div className="batch">
                              <span>-15%</span>
