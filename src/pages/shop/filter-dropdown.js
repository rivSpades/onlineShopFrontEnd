        ...
        <div className="container-xl container-fluid">
          <div className="shop-columns-title-section mb-40">
            ...
            <div className="filter-selector">
              <div className="filter" onClick={handleDropDownFiler}>
              ...
              <div className="col-lg-10">
                <div className="row g-4">
                  <div className="col-lg-3 col-sm-6">
                    <div className="selector">
                    <SelectComponent options={["Skin Care","Hair Care"]} placeholder="Category"/>
                    
                    </div>
                  </div>
                  <div className="col-lg-3 col-sm-6">
                    <div className="selector">
                    <SelectComponent options={["Radiant Vibe","pantene"]} placeholder="Our Brand"/>
                    
                    </div>
                  </div>
                  <div className="col-lg-3 col-sm-6">
                    <div className="selector">
                    <SelectComponent options={["Best Seller","Hot Items"]} placeholder="Highlight"/>
                    </div>
                  </div>
                  <div className="col-lg-3 col-sm-6">
                  <div className="selector">
                    <SelectComponent options={["100-500","500-1000"]} placeholder="price filter"/>
                    </div>
                  </div>
                </div> 
              </div>
              <div className="col-lg-2 d-flex justify-content-center">
                <Link legacyBehavior href="/shop-4-columns"><a  className="primary-btn3 black-bg hover-btn5 hover-white">Filter Now</a></Link>
              </div>
            </div>
          </div>
