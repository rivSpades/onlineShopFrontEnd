...
const Vertical = () => {
  ...
  return (
    ...
    <div className="shop-details-description style-2 mb-110" id="reviews">
      <div className="container-fluid">
        <div className="row">
          <div className="col-12 d-md-flex align-items-center gap-4">
            <div className="shop-details-description-nav">
              <nav>
                <div className="nav flex-md-column nav-tabs" id="nav-tab" role="tablist">
