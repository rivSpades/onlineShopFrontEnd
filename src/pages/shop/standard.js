...
const Standard = () => {
  ...
  return (
    <>
      <div className="shop-standard mt-110 mb-110">
        <div className="container">
          <div className="row gy-5">
            <div className="col-lg-8 order-lg-1 order-2">
              ...
              <div className="all-products mb-80">
                <div className="row gy-4">
                  <div className="col-md-12">
                    <div className="product-card style-6 hover-btn">
                        ...
                        <h6>
                          <Link legacyBehavior href="/shop/product-detail">
                            <a className="hover-underline">
                              Botanical &amp; Organic hair Shampoo
                            </a>
                          </Link>
                        </h6>
                        <p>
                    ...
                    <div className="product-card style-6 hover-btn">
                      ...
                      <div className="product-card-content">
                        <h6>
                          <Link legacyBehavior href="/shop/product-detail">
                            <a className="hover-underline">
                              Organic &amp; Botanical vitamin cream
                            </a>
                          </Link>
                        </h6>
                        <p>
                    ...
                    <div className="product-card style-6 hover-btn">
                      ...
                      <div className="product-card-content">
                        <h6>
                          <Link legacyBehavior href="/shop/product-detail">
                            <a className="hover-underline">
                              Poutsicle Hydrating Modern Lip Stain
                            </a>
                          </Link>
                        </h6>
                        <p>
