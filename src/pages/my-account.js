            ...
            <div className="col-lg-3">
              <div className="dashboard-left">
                <div className="nav flex-column nav-pills " id="v-pills-tab" role="tablist" aria-orientation="vertical">
                  <button className="nav-link active nav-btn-style mx-auto" id="v-pills-dashboard-tab" data-bs-toggle="pill" data-bs-target="#v-pills-dashboard" type="button" role="tab" aria-controls="v-pills-dashboard" aria-selected="true">
                  ...
                  <button className="nav-link nav-btn-style mx-auto" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="true"><i className="lar la-user" /><svg width={20} height={20} viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <button className="nav-link nav-btn-style mx-auto" id="v-pills-order-tab" data-bs-toggle="pill" data-bs-target="#v-pills-order" type="button" role="tab" aria-controls="v-pills-order" aria-selected="true"><svg width={20} height={20} viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <button className="nav-link nav-btn-style mx-auto" id="v-pills-purchase-tab" data-bs-toggle="pill" data-bs-target="#v-pills-purchase" type="button" role="tab" aria-controls="v-pills-purchase" aria-selected="true">
                    <svg width={20} height={20} viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
                    ...
                    Order</button>
                  <button className="nav-link nav-btn-style mx-auto" type="button" role="tab"><svg width={20} height={20} viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="col-lg-9">
              <div className="tab-content" id="v-pills-tabContent">
                    ...
                    <div className="form-wrapper">
                      <form action="#">
                        <div className="row">
                          ...
                          <div className="col-xl-6 col-lg-12 col-md-6 mb-25">
                            <div className="form-inner">
                              <SelectComponent options={["City","Dhaka","Sylhet","Chittagong","Rajshahi"]} placeholder="city"/>
                            </div>
                          </div>
                          <div className="col-xl-6 col-lg-12 col-md-6 mb-25">
                            <div className="form-inner">
                            <SelectComponent options={["City","Dhaka","Sylhet","Chittagong","Rajshahi"]} placeholder="state"/>
                            </div>
                          </div>
                          <div className="col-xl-6 col-lg-12 col-md-6 mb-25">
                            <div className="form-inner">
                          ...
                          <div className="col-xl-6 col-lg-12 col-md-6 mb-25">
                            <div className="form-inner">
                            <SelectComponent options={["Bangladesh","Afganistan","India","China",]} placeholder="Country"/>
                            </div>
                          </div>
                          <div className="col-12 mb-25">
                            <div className="form-inner">
                          ...
                          <div className="col-12">
                            <div className="button-group">
                              <button type="submit" className="primary-btn3 black-bg  hover-btn5 hover-white">Update
                                Profile</button>
                              <button className="primary-btn3 hover-btn5">Cancel</button>
                            </div>
                          </div>
                        </div>
                      </form>
                ...
                <div className="tab-pane fade" id="v-pills-purchase" role="tabpanel" aria-labelledby="v-pills-purchase-tab">
                  ...
                  <div className="table-title-area">
                    <h3>My Order</h3>
                    <SelectComponent options={["Show: Last 05 Order","Show: Last 03 Order","Show: Last 15 Order","Show: Last 20 Order",]} placeholder="orders"/>
